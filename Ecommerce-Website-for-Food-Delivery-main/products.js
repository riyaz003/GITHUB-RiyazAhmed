        ...
        <div class="card card-sm shadow">
            ...
            <div class="card-body">
                ...
                <div class="btn-group btn-rounded gap-2 mb-3" role="group" aria-label="Basic radio toggle button group">
                    <input type="radio" class="btn-check" name="size${index}" id="small${index}" autocomplete="off">
                    <label class="btn btn-outline-danger text-muted" for="small${index}">Small</label>

                    <input type="radio" class="btn-check" name="size${index}" id="medium${index}" autocomplete="off">
                    <label class="btn btn-outline-danger text-muted" for="medium${index}">Medium</label>

                    <input type="radio" class="btn-check" name="size${index}" id="large${index}" autocomplete="off">
                    <label class="btn btn-outline-danger text-muted" for="large${index}">Large</label><br>
                </div>
                <div class="btn-group gap-2 mb-3" role="group" aria-label="Basic radio toggle button group">
                    <input type="radio" class="btn-check" name="crust${index}" id="standard${index}" autocomplete="off">
                    <label class="btn btn-outline-danger text-muted" for="standard${index}">Standard</label>

                    <input type="radio" class="btn-check" name="crust${index}" id="thin${index}" autocomplete="off">
                    <label class="btn btn-outline-danger text-muted" for="thin${index}">Thin</label>
                </div><br>
...
function rendercartitems() {
    ...
    // If the cart is empty, show the "Cart is empty" message
    if (cart.length === 0) {
        cartitemsel.innerHTML = `
                ...
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <td><img src="images/${item.tag}.jpg" height="50" width="50"></td>
